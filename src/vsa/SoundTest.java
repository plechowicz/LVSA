 ...
 * Klasa SoundTest
 * 
 * Klasa odtwarzaj¹ca i nagrywaj¹ca dŸwiêk przy pomocy wybranego miksera
 * 
 * *************************************************
 */
public class SoundTest {
	...
	/**
	 * Autoreferencja do pól steruj¹cych dzia³aniem klasy SoundTest.
	 */
	private MixerChooserFields mixerChooserFieldsAutoref;
	
	/**
	 * Klasy wewnêtrzne inpuSoundTest i outputSoundTest.
	 */
	 ...
	 * @param mixerChooserFields autoreferencja do obiektu klasy
	 */
	...
	/**-------------------------------------------------------------------
	 * 
	 * Klasy wewnêtrzne klasy SounTest
	 * 
	 * -------------------------------------------------------------------
	 */
	 ...
	 * Klasa InputSundTest
	 * 
	 * Test przechwytywania dŸwiêku z mikrofonów
	 * 
	 * ********************************************
	 */
	class InputSoundTest {
		...
		public class Playback implements Runnable {
		    ...
		    public void run() {
		    	...
		    	// Zdefiniowanie atrybutów dla linii,
		    	// i upewnienie siê, ¿e dana linia jest wspierana.
		...
		/**
		 * Zczytanie strumienia wejœciowego
		 */
		class Capture implements Runnable {
		    ...
		    public void run() {
		    	...
		    	// Zapisanie przechwyconego audio z wejœcia
		    	...
		    	// koniec strumienia
		    	// zatrzymanie i zamkniêcie lini
		    	line.stop();
		    	line.close();
		    	line = null;
		    	
		    	// zatrzymanie i zamkniecie strumienia wyjœciowego
		    	try {
		    		baos.flush();
		    		baos.close();
		    	...
		    	// za³adowanie bajtów do audio input stream w celu ich odtworzenia póŸniej
