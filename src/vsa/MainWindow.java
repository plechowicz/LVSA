...
/**
 * Application that implements stress detection procedure
 * used in Voice Stress Analysis
...
public class MainWindow {
	...
	/**
	 * Object which contains different kinds of buttons and panels.
	 * Its constructor takes as an argument frame of the application
	 */
	 ...
	 * @param applicationSize size of the application
	 */
	...
	private void addMenuBar(){
		...
		buttonsAndFields.menuItemMixerChooser.setBorder(new SoftBevelBorder(SoftBevelBorder.RAISED, Color.GRAY, Color.GRAY));
		...
		buttonsAndFields.menuItemAnalysisData.setBorder(new SoftBevelBorder(SoftBevelBorder.RAISED, Color.GRAY, Color.GRAY));
	...
	private void systemExit() {
		int reply = JOptionPane.showConfirmDialog(frame, "Are you sure you want to exit?", "Exit", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
		switch(reply) {
	...
	/**
	 * Class which inherits from JPanel, divided to different
	 * sections associated with choosing, playing 
	 * or recording sound.
	 */
	...
	public class AudioPanel extends JPanel{
		...
		/**
		 * A panel which is intended for control playing or recording audio data. 
		 */
		...
		/**
		 * Add buttons and text field used to open or save a file and inform about file name.
		 */
		...
		/**
		 * Add a panel which is intended for control playing or recording audio data.
		 */
